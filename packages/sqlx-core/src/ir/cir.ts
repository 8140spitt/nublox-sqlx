...
export interface CIR_Column {
    name: string;
    type: string; // dialect-native string for now
    nullable: boolean;
    default?: { kind: 'literal' | 'expr'; text: string } | null;
    generated?: { expr: string; stored: boolean } | null;
...
export interface CIR_Index {
    ...
    parts: Array<{ colOrExpr: string; prefixLen?: number | null }>;
    invisible?: boolean;
}
...
export interface CIR_Check { name?: string | null; expr: string; }
